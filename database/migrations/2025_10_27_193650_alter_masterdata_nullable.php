...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('masterdata', function (Blueprint $table) {
            ...
            $table->boolean('tankotelezettseget_teljesito')->nullable()->change();           
            $table->boolean('sajatos_nevelesi_igenyu')->nullable()->change();                 
            $table->boolean('beilleszkedessel_tanulasi_magatartasi_nehezseggel_kuzd')->nullable()->change();        
            ...
            $table->boolean('vendegtanulo')->nullable()->change();                         
            $table->boolean('egyeni_munkarend')->nullable()->change();                      
            $table->boolean('ideiglenes_ovodai_ideiglenes_vendegtanuloi_jogviszony')->nullable()->change();  
            ...
            $table->boolean('a_bm_szemelyiadat_nyilvantartasaban_beazonositott')->nullable()->change();
