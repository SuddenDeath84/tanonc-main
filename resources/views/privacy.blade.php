            ...
            <div class="card shadow">
                ...
                <div class="card-body justify-content-left">
                                ...
                                <div style="text-align:justify;">
                                    ...
                                    <li>ha e-mailt küld a <a href="mailto:bereczki.istvan@student.nye.hu">NYE-Bereczki István</a> címre;</li>
                                    </ul>
                                    <p><strong><u>11. Adatkezelő, Adatfeldolgozó és az adatkezelésért felelős személyek </u></strong></p>
                                    <p>Az Adatkezelő:</p>
                                    <ul>
                                    <li>Nyíregyházi Egyetem, Programtervező informatikus BSC 2025</li>
                                    </ul>
                                    <p>A kinevezett Adatvédelmi Tisztviselő:</p>
                                    <ul>
                                    <li>Bereczki István</li>
                                    <li>Neptun kód: KAV63X</li>
                                    <li>E-mail cím: bereczki.istvan@student.nye.hu</li>
                                    </ul>
                                    <p>Nyíregyháza, 2025.11.30.</p>
                                    <p>&nbsp;</p>
                                </div>
                </div>
            </div>
